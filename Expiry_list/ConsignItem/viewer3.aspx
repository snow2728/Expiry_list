<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="viewer3.aspx.cs" Inherits="Expiry_list.ConsignItem.viewer3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <%-- Viewer3 Form For all Dept (final - completed list) --%>
<%
...
%>
    ...
    <script type="text/javascript">
        ...
        function initializeComponents() {
            ...
            if (!$.fn.DataTable.isDataTable(grid)) {
                ...
                var cols = [
                    ...
                    /*{ data: null, width: "107px", orderable: false, visible: false }*/
                ];
                    ...
                    ajax: {
                        ...
                        data: function (d) {
                                  return {
                                      ...
                                      completedDate: $('#<%= txtCompletedFilter.ClientID %>').val(),
        ...
        function exportToExcel() {
            window.location.href = "viewer3.aspx?action=export";
        }
        ...
        function setupFilterToggle() {
            const filterMappings = {
                 ...
                 '<%= filterCompletedDate.ClientID %>': '<%= completedFilterGroup.ClientID %>',
        ...
        function initializeFilterVisibility() {
            const filterMap = {
                ...
                completedDate: { 
                    ...
                    groupId: '<%= completedFilterGroup.ClientID %>'
                },
                staff: { 
                       ...
                       <% if (canViewOnly) { %>
                           <div class="d-flex align-items-center">
                               <asp:LinkButton ID="excel" runat="server"
                                   ...
                                   Style="background:#0d330e; display:block;"
                               ...
                               <asp:Button ID="btnExport" runat="server"
                                   ...
                                   CssClass="btn text-white me-2"
                                   Style="background:#0d330e; display:none;"
                                   ForeColor="White" Font-Bold="True" Font-Size="Medium"
                                   ...
                                   <ContentTemplate>
                                       ...
                                       <div id="dynamicFilters">
                                           ...
                                           <div class="form-group mt-3 filter-group" id="regeDateFilterGroup" runat="server" style="display:none">
                                            ...
                                            <div class="form-group mt-3 filter-group" id="completedFilterGroup" runat="server" style="display:none">
                           ...
                           <div class="table-responsive gridview-container " style="height: 673px">
                               <asp:GridView ID="GridView2" runat="server"
                                   ...
                                   AutoGenerateEditButton="false" ShowHeaderWhenEmpty="true" >
                                        ...
                                        <HeaderStyle Wrap="true" BackColor="#477023" Font-Bold="True" ForeColor="White"></HeaderStyle>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="viewer2.aspx.cs" Inherits="Expiry_list.ConsignItem.viewer2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

   <%-- Viewer2 Form For Store Dept (final2 - Incompleted list) --%>
...
<script type="text/javascript">
                ...
                ajax: {
                    ...
                    data: function (d) {
                        return {
                            ...
                            countingDate: $('#<%= txtCompletedFilter.ClientID %>').val(),
    ...
    function setupFilterToggle() {
        const filterMappings = {
             ...
             '<%= filterCompletedDate.ClientID %>': '<%= completedDateFilterGroup.ClientID %>',
    ...
    const filterMap = {
         ...
         countingDate: { 
             ...
             controlId: '<%= txtCompletedFilter.ClientID %>',
             groupId: '<%= completedDateFilterGroup.ClientID %>'
         },
         staff: { 
 ...
 <div class="container-fluid col-lg-12">
  <div class="card shadow-md border-dark-subtle">
      <div class="card-header" style="background-color:#477023;">
          <h4 class="text-center text-white">Consignment Item List</h4>
      </div>
        <div class="card-body">
            ...
            <div class="d-flex align-items-center flex-wrap mb-2">
                ...
                <div>
                    <asp:Button ID="btnFilter" class="btn me-1 text-white" style="background:#0d330e" runat="server" Text="Show Filter" CausesValidation="false" OnClientClick="toggleFilter(); return false;" OnClick="btnFilter_Click1" />
                </div>
                        ...
                        <asp:Panel ID="Panel1" runat="server" Visible="true" >
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <!--Completed Filter -->
                                    <div class="form-group mt-3 filter-group" id="completedDateFilterGroup" runat="server" style="display:none">
                                        <label for="<%= txtCompletedFilter.ClientID %>">Completed Date</label>
                                        <asp:TextBox ID="txtCompletedFilter" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
                                    </div>
                         ...
                         <div class="table-responsive gridview-container " style="height: 673px">
                             <asp:GridView ID="GridView2" runat="server"
                                 ...
                                 AutoGenerateEditButton="false" ShowHeaderWhenEmpty="true"  >
                                     ...
                                     <HeaderStyle Wrap="true" BackColor="" Font-Bold="True" ForeColor="White"></HeaderStyle>
                                     ...
                                     <Columns>
                                        ...
                                        <asp:BoundField DataField="id" HeaderText="ID" Visible="false" />
                                         <asp:TemplateField ItemStyle-HorizontalAlign="Justify" HeaderText="No" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderStyle-CssClass="position-sticky top-0 z-3 sticky-header1a" ItemStyle-CssClass="fixed-column-1a">
                                             <ItemTemplate>
                                      ...
                                      <asp:TemplateField HeaderText="Lines No" SortExpression="no" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Justify" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderStyle-CssClass="position-sticky top-0 z-3 sticky-header2a" ItemStyle-CssClass="fixed-column-2a" >
                                         <ItemTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="Item No" SortExpression="itemNo" HeaderStyle-ForeColor="White" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Justify" HeaderStyle-CssClass="position-sticky top-0 z-3 sticky-header3a" ItemStyle-CssClass="fixed-column-3a">
                                         <ItemTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="Description" SortExpression="description" HeaderStyle-ForeColor="Black" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Justify" HeaderStyle-CssClass="position-sticky top-0 z-3 sticky-header4a" ItemStyle-CssClass="fixed-column-4a" >
                                         <ItemTemplate>

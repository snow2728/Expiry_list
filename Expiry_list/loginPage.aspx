...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        // Push an initial state so that the current page is in the history.
        history.pushState(null, null, location.href);

        // When the user clicks back, force a reload.
        window.addEventListener("popstate", function (event) {
            // This reload forces the page to be re-fetched from the server.
            location.reload();
        });
    </script>

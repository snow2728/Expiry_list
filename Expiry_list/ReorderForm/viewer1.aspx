...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <a href="../AdminDashboard.aspx" class="btn text-white ms-2" style="background-color: #9E7CD7;"><i class="fa-solid fa-left-long"></i> Home</a>

 <div class="container-fluid col-lg-12 col-md-12">
     <div class="card shadow-md border-dark-subtle">
         <div class="card-header" style="background-color:#9E7CD7;">
                     ...
                     <div class="col-12 col-md-auto">
                       ...
                       <div class="col-12 col-md-auto">
                         <asp:DropDownList ID="ddlStatus" runat="server"
                            ...
                            <asp:ListItem Value="1" Text="Reorder Added" />
                            <asp:ListItem Value="2" Text="No Reorder Added" />
                        </asp:DropDownList>
                       </div>
                                 ...
                                 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                     <ContentTemplate>
                                         ...
                                         <div class="mb-3">
                                             ...
                                             <div class="dropdown">
                                                 <button class="btn dropdown-toggle text-white" style="background-color:#9E7CD7;"
                                         ...
                                         <div id="dynamicFilters">
                                             ...
                                             <div class="form-group mt-3 filter-group" id="statusFilterGroup" runat="server" style="display:none">
                                                 ...
                                                 <asp:DropDownList ID="ddlStatusFilter" runat="server" CssClass="form-control">
                                                     ...
                                                     <asp:ListItem Value="1" Text="Reorder Added"></asp:ListItem>
                                                     <asp:ListItem Value="2" Text="No Reorder Added"></asp:ListItem>
                                                 </asp:DropDownList>
                                             </div>
                 ...
                 <div class="col-md-12 ms-3" id="gridCol">
                     ...
                     <ContentTemplate>
                        ...
                        <asp:Panel ID="pnlNoData" runat="server" Visible="false">
                         ...
                         <div class="table-responsive gridview-container " style="height: auto;" >
                             <asp:GridView ID="GridView2" runat="server"
                                 ...
                                 <HeaderStyle Wrap="true" BackColor="#9E7CD7" Font-Bold="True" ForeColor="White"></HeaderStyle>
                                 ...
                                 <Columns>
                                     ...
                                     <asp:TemplateField HeaderText="" HeaderStyle-CssClass="position-sticky top-0 z-3 sticky-header1" ItemStyle-CssClass="fixed-column-1">
                                        ...
                                        <ControlStyle Width="50px" />
                                         <HeaderStyle ForeColor="White" BackColor="#9E7CD7" />
                                     ...
                                     <asp:TemplateField HeaderText="Lines No" ItemStyle-Width="100px" SortExpression="no" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Justify" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderStyle-CssClass="position-sticky top-0 z-3 sticky-header3" ItemStyle-CssClass="fixed-column-3">
                                         ...
                                         </ItemTemplate><HeaderStyle ForeColor="White" BackColor="#9E7CD7" />
                                     ...
                                     <asp:TemplateField HeaderText="Registration Date" SortExpression="regeDate" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Justify" HeaderStyle-CssClass="position-sticky top-0" ItemStyle-CssClass="fixed-column-56">
                                         ...
                                         <ItemStyle HorizontalAlign="Justify" />
                                          ...
                                          <asp:TemplateField HeaderText="Approver" SortExpression="staffName" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Justify" HeaderStyle-CssClass="position-sticky top-0" ItemStyle-CssClass="fixed-column-52">
                                             <ItemTemplate>
                                    ...
                                    <%--  <asp:TemplateField HeaderText="Approval Status" SortExpression="approval" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Justify" HeaderStyle-CssClass="position-sticky top-0" ItemStyle-CssClass="fixed-column-53">
                                         <ItemTemplate>
                                             <asp:Label ID="lblApprove" runat="server" Text='<%# Eval("approved") %>' />
                                         </ItemTemplate>
                                         <ControlStyle Width="120px" />
                                         <HeaderStyle ForeColor="White" BackColor="#9E7CD7" />
                                         <ItemStyle HorizontalAlign="Justify" />
                                     ...
                                     <asp:TemplateField HeaderText="Reason" SortExpression="action" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Justify" HeaderStyle-CssClass="position-sticky top-0" ItemStyle-CssClass="fixed-column-57">
                                         <EditItemTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="Action" SortExpression="status" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Justify" HeaderStyle-CssClass="position-sticky top-0" ItemStyle-CssClass="fixed-column-58">
                                         <EditItemTemplate>
                           ...
                           <%--              <EditItemTemplate>
                                     ...
                                     <asp:CommandField ShowEditButton="true" ShowCancelButton="true" ItemStyle-BackColor="white" ControlStyle-CssClass="btn m-1 text-white"
                                         EditText="-" UpdateText="<i class='fa-solid fa-file-arrow-up'></i>"
                                         CancelText="<i class='fa-solid fa-xmark'></i>">
                                         <ControlStyle CssClass="btn m-1 text-white" Width="75px" BackColor="#9E7CD7" />
                                         <HeaderStyle ForeColor="White" BackColor="#9E7CD7" />
                                         <ItemStyle HorizontalAlign="Justify" />
                                     </asp:CommandField>

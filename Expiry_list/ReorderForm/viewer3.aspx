...
%>
    ...
    function refreshDataTable() {
              const grid = $("#<%= GridView2.ClientID %>");
        if ($.fn.DataTable.isDataTable(grid)) {
            grid.DataTable().ajax.reload(null, false); // Preserve current paging
        }
    }
...
<div class="container-fluid col-lg-12 col-md-12">
    <div class="card shadow-md border-0" style="background-color: #D0C9EA;">
        <div class="card-header" style="background-color: #996FD6;">
        ...
        <div class="card-body">
            ...
            <div class="d-flex align-items-center flex-wrap mb-2">
                ...
                <div>
                    <asp:Button ID="btnFilter" class="btn me-1 text-white"  Style="background: #9E7CD7;" runat="server" Text="Show Filter" CausesValidation="false" OnClientClick="toggleFilter(); return false;" OnClick="btnFilter_Click1" />
                </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="dropdown">
                                             <button class="btn dropdown-toggle text-white" Style="background: #9E7CD7;"

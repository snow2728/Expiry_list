      ...
      <script type="text/javascript">
          ...
          function focusOnEditedRow() {
              ...
              if ($.fn.DataTable.isDataTable(grid)) {
                  ...
                  // FIXED: Properly handle DataTables row indexing
...
<div class="container-fluid col-lg-12 col-md-12">
    <div class="card shadow-md border-0" style="background-color: #D0C9EA;">
        <div class="card-header" style="background-color: #996FD6;">
            <h4 class="text-center text-white">Approval List</h4>
        </div>
                ...
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-12 col-md-auto">
                        <asp:Button ID="btnApproveSelected" runat="server"
                            ...
                            Style="background: #ffffff; color:#9E7CD7;"
                            Text="Approve"
                            ...
                            <div class="table-responsive gridview-container p-1 rounded-1" style="height: auto;">
                                   <asp:GridView ID="GridView2" runat="server"
                                        ...
                                        <Columns>
                                           ...
                                           <asp:TemplateField HeaderText="Approval Status" SortExpression="approved" 
                                                HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" 
                                                ItemStyle-HorizontalAlign="Justify" HeaderStyle-CssClass="position-sticky top-0" 
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("approved").ToString().ToUpperInvariant() %>' />
                                                </ItemTemplate>
                                            ...
                                            <asp:CommandField ShowEditButton="true" ShowCancelButton="true" ControlStyle-CssClass="m-1 text-white"
                                                ...
                                                <ControlStyle CssClass="btn m-1 text-white" Width="105px" BackColor="#9E7CD7" />

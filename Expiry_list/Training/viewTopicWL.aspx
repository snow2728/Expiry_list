...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <a href="../AdminDashboard.aspx" class="btn text-white ms-2" style="background-color : #022f56;"><i class="fa-solid fa-left-long"></i> Home</a>
           ...
           <div class="d-flex justify-content-between align-items-center mb-4">
               <h2>Topic With List</h2>
               <a href="addTopic.aspx" class="btn text-white" style="background-color:#022f56;"><i class="fa-solid fa-user-plus"></i> Add New Topic With Level</a>
           </div>
                ...
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover border border-2 shadow-lg sticky-grid mt-1 overflow-scroll"
                    ...
                    <Columns>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Justify" HeaderText="No" 
                            ...
                            HeaderStyle-CssClass="position-sticky top-0 z-3 sticky-header2" 
                            ItemStyle-CssClass="fixed-column-2">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Topic Name" SortExpression="topic" 
                            ...
                            ItemStyle-CssClass="fixed-column-1">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Trainee Level" SortExpression="traineeLevel" 
                            ...
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddlTraineeLevel" runat="server" CssClass="form-control">

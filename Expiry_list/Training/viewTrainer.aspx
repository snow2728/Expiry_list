...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <a href="../AdminDashboard.aspx" class="btn text-white ms-2" style="background-color : #022f56;"><i class="fa-solid fa-left-long"></i> Home</a>
         ...
         <div class="d-flex justify-content-between align-items-center mb-4">
             <h2>Trainer List</h2>
             <a href="addTrainer.aspx" class="btn text-white" style="background-color:#022f56;"><i class="fa-solid fa-user-plus"></i> Add New Trainer</a>
         </div>
...
<%--                              <asp:TextBox ID="txtPosition" runat="server" Text='<%# Bind("position") %>' 
                                  CssClass="form-control" />--%>
                               <asp:DropDownList ID="txtPosition" runat="server" CssClass="form-control form-control-sm dropdown-icon">
